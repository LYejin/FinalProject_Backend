...
public class StradeController {
    ...
    // 그리드 부서코드 유효성
    @GetMapping("gridUseDeptCd")
    public ResponseEntity<String> gridUseDeptCd(GridDeptCdDTO gridDeptCdDTO) {
    ...
    public ResponseEntity<String> gridUseEmpCd(GridEmpCdDTO gridEmpCdDTO) {
